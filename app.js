...
$(document).ready(function() {
  ...
  var villains = ["jafar", "ursula", "yzma", "scar", "gaston", "hades", "iago", "maleficent", "ratcliffe", "shan yu"];
  ...
  $("#gifsearch").on("click", function(event) {
    ...
    var villain = $("#gifsearch").val().trim(); //will have to double-check this... doesn't look quite right
    createButtons();
